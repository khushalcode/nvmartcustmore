...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        ...
        authDomain: "new--nc-mart2026.firebaseapp.com",
        projectId: "new--nc-mart2026",
        storageBucket: "new--nc-mart2026.appspot.com",
        messagingSenderId: "888731977079",
        appId: "1:888731977079:web:08848eebd849f746abcd72"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDc26iMpNeWGE3Mfabf-ln-8ZQKIkZaeiE",
        appId: "1:888731977079:android:ea4c534b4a59a923abcd72",
        messagingSenderId: "888731977079",
        projectId: "new--nc-mart2026",
      ),
    );
